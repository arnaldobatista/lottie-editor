...
class Editor extends React.Component {
  ...
  componentDidMount() {
    initState = JSON.parse(JSON.stringify(this.state));
  ...
  changeColor = (color, event) => {
    ...
    const colorGroup =
      this.state.parsedColors[this.state.rootLayerPath][
    ...
    this.setState(
      {
        ...
        ...{
          animationPreviewBackgroundColor:
            this.state.animationPreviewBackgroundColor,
        },
      },
      () => {
        this.setColors();
    ...
    return (
      <div className='main'>
        ...
        <div className='previewWrapper'>
          <a
            target='_blank'
            href='https://github.com/magna25/lottie-editor'
            id='github-link'
